...
class BenchmarkGenerator:
        ...
        templates = {
            "electric_vehicles": [
                # Price and Cost Questions
                {
                    ...
                    "difficulty": "hard",
                    "variables": {
                        "charging_type": ["350kW DC fast", "50kW DC", "22kW AC", "11kW AC"],
                ...
                },
                {
                    ...
                    "difficulty": "medium",
                    "variables": {
                        "ev_model": ["Tesla Model 3", "VW ID.4", "BMW i4", "Audi e-tron", "Mercedes EQS"],
                ...
                # Compatibility Questions
                {
                    ...
                    "difficulty": "medium",
                    "variables": {
                        "charger_type": ["Tesla Supercharger", "CCS2 charger", "CHAdeMO", "Type 2 AC"],
                        "ev_model": ["Tesla Model 3", "VW ID.4", "Nissan Leaf", "BMW i4"],
                ...
                # Technical Specifications
                {
                    ...
                    "difficulty": "easy",
                    "variables": {
                        "ev_model": ["Tesla Model 3", "Porsche Taycan", "Audi e-tron GT", "Lucid Air"],
                        "max_speed": ["250", "270", "270", "300"],
                        "connector_type": ["Supercharger V3", "800V architecture", "800V system", "900V system"]
                    }
                },
                ...
                # Range and Efficiency
                {
                    ...
                    "difficulty": "medium",
                    "variables": {
                        "ev_model": ["Tesla Model 3 LR", "VW ID.4", "BMW i4", "Mercedes EQS"],
                ...
                # Charging Infrastructure
                {
                    ...
                    "difficulty": "hard",
                    "variables": {
                        "charger_type": ["DC fast", "Tesla Supercharger", "public AC", "high-power"],
                        "country": ["Germany", "Netherlands", "Norway", "Sweden", "France"],
            ...
            "technology": [
                {
                    ...
                    "variables": {
                        ...
                        "cpu2": ["Intel i5-12600K", "AMD Ryzen 5 5600X", "Intel i7-11700K"],
    ...
    def generate_benchmark(self, num_questions: int = 50, 
                          difficulty_distribution: Optional[Dict[str, float]] = None,
                          category_distribution: Optional[Dict[str, float]] = None) -> List[BenchmarkQuestion]:
        """
        ...
        if not self.question_templates:
            self.logger.warning(f"No question templates found for domain: {self.domain}")
            return []
        ...
        self.logger.info(f"Generated {len(questions)} benchmark questions for domain: {self.domain}")
        return questions
    
    def _select_template_by_distribution(self, category_distribution: Dict[str, float]) -> Optional[Dict[str, Any]]:
        """Select template based on category distribution"""
        available_templates = []
        for template in self.question_templates:
    ...
    def _generate_question_from_template(self, template: Dict[str, Any]) -> Optional[BenchmarkQuestion]:
        ...
        try:
            ...
            for var_name, var_values in variables.items():
                if isinstance(var_values, list):
                    ...
                    question_text = question_text.replace(f"{{{var_name}}}", str(selected_value))
                    answer_text = answer_text.replace(f"{{{var_name}}}", str(selected_value))
    ...
    def create_adversarial_benchmark(self, num_questions: int = 20) -> List[BenchmarkQuestion]:
        ...
        adversarial_templates = [
            ...
            },
            {
                ...
                "variables": {
                    ...
                    "reduction": ["20", "15", "25"],
                    "reason": ["battery temperature management", "safety protocols", "thermal throttling"]
                }
            },
            {
                ...
                "variables": {
                    ...
                    "range_loss": ["45", "30", "60"],
                    "degradation_factor": ["capacity loss", "internal resistance", "cell aging"]
                }
            }
        ]
    ...
    def load_benchmark(self, input_path: str, format: str = "jsonl") -> List[BenchmarkQuestion]:
    ...
    def validate_benchmark(self) -> Dict[str, Any]:
        ...
        for i, question in enumerate(self.questions):
            ...
            if "{" in question.answer or "}" in question.answer:
                warnings.append(f"Question {i}: Answer contains unsubstituted variables")
